...
{
	UE_LOG(LogTemp, Warning, TEXT("Constructor of Contact Manager"));
	// Default type
...
{
	Super::BeginPlay();
	//UE_LOG(LogTemp, Warning, TEXT("BeginPlay Contact Manager"));
	...
	if (SemLogRuntimeManager)
	{
		...
		//UE_LOG(LogTemp, Warning, TEXT("Look for overlapping actors"));
		...
		for (const auto& ActItr : CurrOverlapingActors)
		{
			...
			//UE_LOG(LogTemp, Warning, TEXT("Overlapping Actor Name:  %s"), *ActItr->GetName());
		}
	}
}
...
{
	//UE_LOG(LogTemp, Warning, TEXT("Start overlap Event"));
	// Start event
...
{
	//UE_LOG(LogTemp, Warning, TEXT("End Overlap Events"));
...
{
	//UE_LOG(LogTemp, Warning, TEXT("Start Contact Event"));
	...
	if (TagIndex != INDEX_NONE)
	{
		...
		*********************************************************************/
		...
		{
			//UE_LOG(LogTemp, Warning, TEXT("Add Contact Event to list"));

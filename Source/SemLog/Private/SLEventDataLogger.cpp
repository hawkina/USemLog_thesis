...
USLEventDataLogger::USLEventDataLogger()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("Constructor of Event Data Logger"));
}
...
{
	//UE_LOG(LogTemp, Warning, TEXT("Initialize Event Logger."));
	if (!bIsInit)
	{
...
{
	//UE_LOG(LogTemp, Warning, TEXT("Start an Event: %s"), *Event.Get()->ToXmlString());
	if (bIsStarted)
	{		

...
ASLRuntimeManager::ASLRuntimeManager()
{
	...
	bWriteEventTimelines = true; // was false
	bBroadcastEventData = false; //was false

	// Event filter
	bFilterEvents = false; // was false
	bFilterAll = false; // was false
	MinDurationFilter = 0.1;

	// Concatenate events
	bConcatenateEvents = false; // was false
...
void ASLRuntimeManager::Tick(float DeltaTime)
{
	...
	//UE_LOG(LogTemp, Warning, TEXT("LogDynamicEntities Tick"));
	// Log every tick instead
...
void ASLRuntimeManager::AddNewEntity(AActor* Actor)
{
	...
	if (bLogEventData && EventDataLogger)
	{
		UE_LOG(LogTemp, Warning, TEXT("Event Data Logger"));
		...
		if (TagIndex != INDEX_NONE)
		{
			...
			*********************************************************************/
			...
			// Create the event
			UE_LOG(LogTemp, Warning, TEXT("Create new Event"));
...
{
	UE_LOG(LogTemp, Warning, TEXT("Remove Entity called"));
	if (bLogRawData && RawDataLogger)
	{
		// Remove entity from logging
